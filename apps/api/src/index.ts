...
import productMatchRoutes from './routes/product-match';
import outfitRoutes from './routes/outfits';
import outfitSuggestRoutes from './routes/outfit-suggest';
...
app.route('/wardrobe', productMatchRoutes);
app.route('/outfits', outfitRoutes);
app.route('/outfits', outfitSuggestRoutes);
