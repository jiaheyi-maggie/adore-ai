...
interface StyleRadarCardProps {
  dimensions: StyleDimensions;
  userName: string;
}

export default function StyleRadarCard({ dimensions, userName }: StyleRadarCardProps) {
  ...
  const handleShare = useCallback(async () => {
    try {
      ...
      await Sharing.shareAsync(uri, {
        mimeType: 'image/png',
        dialogTitle: 'Share your Style DNA',
      });
    } catch (err) {
    ...
    <View style={styles.wrapper}>
      ...
      >
        <View style={styles.card} collapsable={false}>
          ...
          <StyleRadar dimensions={dimensions} size={200} showLabels={true} />
